    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.chrome.driver", "/Users/vaneetsharma/Downloads/Finalautomation/Generic/src/main/resources/chromedriver 2");
            ...
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.gecko.driver", "/Users/vaneetsharma/Downloads/Finalautomation/Generic/src/main/resources/chromedriver");
            }else if(OS.equalsIgnoreCase("Windows")) {
                System.setProperty("webdriver.gecko.driver", "/Users/vaneetsharma/Downloads/Finalautomation/Generic/src/main/resources/chromedriver");
            }
